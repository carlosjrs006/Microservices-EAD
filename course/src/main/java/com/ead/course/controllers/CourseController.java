...
public class CourseController {
    ...
    @GetMapping
    public ResponseEntity<Page<CourseModel>> getAllCourses(SpecficationTemplate.CourseSpec spec,
        ...
        if(userId != null){
            courseModelPage = courseService.findAll(SpecficationTemplate.courseUserId(userId).and(spec), pageable);
        }else{
