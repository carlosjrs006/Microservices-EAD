...
public class SpecficationTemplate {
    ...
    @And({
         @Spec(path = "couserLevel", spec = Equal.class),
    ...
    public static Specification<LessonModel> lessonModuleId(final UUID moduleId){
        return (root, query, cb) -> {
            ...
            return cb.and(cb.equal(module.get("moduleId"), moduleId), cb.isMember(lesson,lessonsModules));
        };
    }
}
